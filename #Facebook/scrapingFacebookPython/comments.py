...
#page_id = "pp"
#page_id = "psoe"
#page_id = "cs.ciudadanos"
#page_id = "ahorapodemos"
#page_id = "juntspelsi"
#page_id = "Esquerra.ERC"
#page_id = "unitatpopular"
page_id = "vox.espana"

#Caducan cada hora o así:
access_token = "" #obtenido de la API de Facebook
...
def scrapeFacebookPageFeedComments(page_id, access_token):
    with open('%s_facebook_comments.csv' % page_id, 'w') as file:
        ...
        with open('%s_facebook_statuses.csv' % page_id, 'rt') as csvfile:
